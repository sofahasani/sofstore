            ...
            <div class="settings-group">
                ...
                <form id="accountForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-input" value="{{ auth()->user()->email }}" name="email">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Nomor Telepon</label>
                        <input type="tel" class="form-input" value="{{ auth()->user()->phone ?? '' }}" name="phone">
                    </div>
            ...
            <div class="settings-group">
                ...
                @if(auth()->user()->address)
                    <div class="address-card default">
                        ...
                        <div style="font-weight: 600; margin-bottom: 5px;">{{ auth()->user()->name }}</div>
