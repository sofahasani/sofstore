    ...
    <div class="container">
        ...
        <div class="page-header">
            <div class="header-content">
                ...
                <h1>❤️ Wishlist Saya ({{ $wishlists->count() }})</h1>
            </div>
        </div>
        ...
        @if($wishlists->isEmpty())
            ...
            <div class="empty-state">
                ...
                <a href="{{ route('dashboard') }}" class="shop-btn">🛍️ Mulai Belanja</a>
            </div>
        @else
            <!-- Wishlist Products -->
            <div class="wishlist-grid">
                @foreach($wishlists as $wishlist)
                <div class="product-card" id="wishlist-{{ $wishlist->id }}">
                    <form action="{{ route('wishlist.destroy', $wishlist->id) }}" method="POST" class="remove-form">
                        @csrf
                        @method('DELETE')
                    ...
                    <div class="product-info">
                        <a href="{{ route('products.show', $wishlist->product->id) }}" style="text-decoration: none;">
                        ...
                        <div class="product-actions">
                            <button class="btn btn-add" onclick="addToCart({{ $wishlist->product->id }})">
                                🛒 Keranjang
                            </button>
                            <a href="{{ route('products.show', $wishlist->product->id) }}" class="btn btn-view">
                                👁️ Lihat
                            </a>
                        </div>
                    </div>
