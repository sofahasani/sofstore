...
<head>
    ...
    <title><?php echo $__env->yieldContent('page-title', 'Admin Dashboard'); ?> - Premium Panel</title>
    ...
    <div class="admin-container">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-menu">
                ...
                <a href="<?php echo e(route('products.index')); ?>" class="menu-item <?php echo e(request()->routeIs('products.*') ? 'active' : ''); ?>">
                    <span class="menu-icon">📦</span>
                    <span class="menu-text">Produk</span>
                </a>
                <a href="<?php echo e(route('admin.orders.index')); ?>" class="menu-item <?php echo e(request()->routeIs('admin.orders.*') ? 'active' : ''); ?>">
                    <span class="menu-icon">🚚</span>
                ...
                <a href="<?php echo e(route('welcome')); ?>" class="menu-item">
                    <span class="menu-icon">🏠</span>
        ...
        <main class="main-content">
            ...
            <header class="header">
                <div class="header-left">
                    <h1><?php echo $__env->yieldContent('page-title', 'Dashboard Overview'); ?></h1>
                </div>
...
<?php /**PATH C:\laragon\www\projectwahab\resources\views/admin/layouts/admin.blade.php ENDPATH**/ ?>