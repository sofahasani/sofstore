...
<body>
    ...
    <div class="header">
        ...
        <div class="header-right">
            <button class="header-icon" onclick="window.location.href='<?php echo e(route('cart.index')); ?>'">
                <i class="fas fa-cog"></i>
            </button>
            <button class="header-icon" onclick="window.location.href='<?php echo e(route('cart.index')); ?>'">
            <button class="header-icon" onclick="window.location.href='<?php echo e(route('cart.index')); ?>'">
                <i class="fas fa-shopping-cart"></i>
                <?php if(auth()->user()->carts && auth()->user()->carts->count() > 0): ?>
                <span class="badge"><?php echo e(auth()->user()->carts->count()); ?></span>
                <?php endif; ?>
            </button>
            <button class="header-icon" onclick="window.location.href='<?php echo e(route('chat.index')); ?>'">
        ...
        <div class="profile-info">
            ...
            <div class="profile-details">
                <div class="profile-name">
                    <?php echo e(auth()->user()->name ?? explode('@', auth()->user()->email)[0]); ?>
                ...
                <div class="profile-stats">
                    <div class="stat">
                        ...
                        <span><?php echo e(auth()->user()->orders ? auth()->user()->orders->count() : 0); ?> Pengikut</span>
                    </div>
                    <div class="stat">
                        <i class="fas fa-heart"></i>
                        <span><?php echo e(auth()->user()->wishlists ? auth()->user()->wishlists->count() : 0); ?> Mengikuti</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="section">
        <div class="section-header">
            ...
            <a href="<?php echo e(route('orders.index')); ?>" class="section-link">Lihat Riwayat Pesanan <i class="fas fa-chevron-right"></i></a>
        </div>
        <div class="order-grid">
            <a href="<?php echo e(route('orders.index')); ?>?status=pending" class="order-item">
                ...
                <span class="order-badge"><?php echo e($pendingCount); ?></span>
                <?php endif; ?>
            </a>
            <a href="<?php echo e(route('orders.index')); ?>?status=processing" class="order-item">
                <div class="order-icon">
                ...
                <span class="order-badge"><?php echo e($processingCount); ?></span>
                <?php endif; ?>
            </a>
            <a href="<?php echo e(route('orders.index')); ?>?status=shipped" class="order-item">
                <div class="order-icon">
                ...
                <span class="order-badge"><?php echo e($shippedCount); ?></span>
                <?php endif; ?>
            </a>
            <a href="<?php echo e(route('orders.index')); ?>?status=completed" class="order-item">
                <div class="order-icon">
                ...
                <span class="order-badge"><?php echo e($reviewCount); ?></span>
                <?php endif; ?>
            </a>
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="menu-list">
            <a href="<?php echo e(route('wishlist.index')); ?>" class="menu-item">
            ...
            <a href="<?php echo e(route('orders.index')); ?>" class="menu-item">
            ...
            <a href="<?php echo e(route('reviews.index')); ?>" class="menu-item">
    ...
    <div class="bottom-nav">
        ...
        <a href="#" class="nav-item">
            ...
            ?>
            <?php if($totalNotif > 0): ?>
            <span class="nav-badge"><?php echo e($totalNotif); ?></span>
            <?php endif; ?>
        </a>
        <a href="<?php echo e(route('profile')); ?>" class="nav-item active">
        ...
        <div class="modal-content">
            ...
            <form id="editForm" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-input" value="<?php echo e(auth()->user()->name ?? explode('@', auth()->user()->email)[0]); ?>" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="tel" name="phone" class="form-input" value="<?php echo e(auth()->user()->phone); ?>" placeholder="+62">
                </div>

                <div class="form-group">
                    <label class="form-label">Alamat Lengkap</label>
                    <textarea name="address" class="form-textarea" placeholder="Masukkan alamat lengkap"><?php echo e(auth()->user()->address); ?></textarea>
                </div>

                <div class="form-group">
                    <label class="form-label">Bio</label>
                    <textarea name="bio" class="form-textarea" placeholder="Ceritakan tentang diri Anda"><?php echo e(auth()->user()->bio); ?></textarea>
                </div>
...
<?php /**PATH C:\laragon\www\projectwahab\resources\views/profile.blade.php ENDPATH**/ ?>