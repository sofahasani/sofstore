...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="header-right">
                ...
                <div class="cart-container">
                    <button class="icon-btn" onclick="window.location.href='<?php echo e(route('cart.index')); ?>'">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width="2">
        ...
        <div class="image-section">
            <img src="<?php echo e($product->image ? asset('storage/' . $product->image) : 'https://via.placeholder.com/400x400/f8f9fa/ff7300?text=' . urlencode($product->name ?? 'Produk')); ?>" 
        ...
        <div class="product-info">
            <div class="product-header">
                ...
                <button class="like-btn" id="likeBtn" data-liked="false" data-product-id="<?php echo e($product->id); ?>">
            ...
            <div class="stock-section">
                <div class="stock-header">
                    ...
                    <span class="stock-count <?php echo e($product->stock < 10 ? 'low' : ''); ?>">
                        <?php echo e($product->stock ?? 50); ?> unit
                    </span>
                </div>
                <div class="stock-progress">
                    <div class="stock-progress-bar <?php echo e($product->stock < 10 ? 'low' : ($product->stock < 30 ? 'medium' : '')); ?>" 
                         style="width: <?php echo e(min(($product->stock / 100) * 100, 100)); ?>%">
                    </div>
                </div>
            </div>
            ...
            <div class="tab-content active" id="tab-description">
                ...
                <p class="description-text">
                    <?php echo e($product->description ?? 'Produk berkualitas tinggi dengan desain modern dan performa maksimal. Cocok untuk penggunaan sehari-hari maupun profesional. Dilengkapi dengan fitur-fitur canggih yang memudahkan aktivitas Anda.'); ?>
            ...
            <div class="tab-content" id="tab-specs">
                ...
                <table class="details-table">
                    <tr>
                        ...
                        <td class="value"><?php echo e($product->category ?? 'Electronic / Accessories'); ?></td>
                    </tr>
                    <tr>
                        <td class="label">Brand</td>
                        <td class="value"><?php echo e($product->brand ?? 'DJI'); ?></td>
                    </tr>
                    <tr>
                        <td class="label">Model</td>
                        <td class="value"><?php echo e($product->name); ?></td>
                    </tr>
                    <tr>
            ...
            <div class="reviews-section" style="margin-top: 40px; margin-bottom: 40px;">
                    ...
                    <div style="display: flex; align-items: center; gap: 32px;">
                        ...
                        <div style="text-align: center; min-width: 120px;">
                            ...
                            <div style="font-size: 20px; margin-bottom: 4px;">
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <span style="color: <?php echo e($i <= round($product->average_rating) ? '#fbbf24' : '#e5e7eb'); ?>;">★</span>
                                <?php endfor; ?>
                            </div>
                            <div style="color: #78716c; font-size: 13px;"><?php echo e($product->total_reviews); ?> ulasan</div>
                        </div>
                        ...
                        <div style="flex: 1;">
                            <?php
                                $ratings = [5,4,3,2,1];
                            ?>
                            <?php $__currentLoopData = $ratings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $star): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 8px;">
                                    <span style="min-width: 45px; font-size: 13px; color: #78716c;"><?php echo e($star); ?> ★</span>
                                    <div style="flex: 1; background: #e7e7e5; height: 6px; border-radius: 3px; overflow: hidden;">
                                        <div style="background: #fbbf24; height: 100%; width: <?php echo e($percentage); ?>%; transition: width 0.3s ease;"></div>
                                    </div>
                                    <span style="min-width: 30px; text-align: right; font-size: 12px; color: #a8a29e;"><?php echo e($count); ?></span>
                                </div>
                ...
                <div class="reviews-list">
                    ...
                    <div style="background: white; border: 1px solid #e7e7e5; border-radius: 12px; padding: 20px; margin-bottom: 16px;">
                            ...
                            <div style="flex: 1;">
                                <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 6px;">
                                    <div style="width: 36px; height: 36px; background: #1c1917; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 600; font-size: 14px;">
                                        <?php echo e(strtoupper(substr($review->reviewer_name, 0, 1))); ?>
                                    ...
                                    <div>
                                        ...
                                        <div style="color: #a8a29e; font-size: 12px;"><?php echo e($review->created_at->diffForHumans()); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div style="font-size: 16px;">
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                <span style="color: <?php echo e($i <= $review->rating ? '#fbbf24' : '#e5e7eb'); ?>;">★</span>
                                <?php endfor; ?>
                            </div>
                        </div>
                        ...
                        <p style="color: #57534e; font-size: 14px; line-height: 1.6; margin: 0 0 12px 0;"><?php echo e($review->comment); ?></p>
                        <?php endif; ?>
                        
                        <!-- Review Actions -->
                        <?php if(auth()->check() && (auth()->id() === $review->user_id || auth()->user()->role === 'admin')): ?>
                        <form action="<?php echo e(route('reviews.destroy', $review)); ?>" method="POST" style="margin: 0;" onsubmit="return confirm('Hapus ulasan ini?')">
                            <?php echo csrf_field(); ?>
            ...
            <div class="related-section">
                ...
                <div class="related-products">
                    ...
                    <a href="<?php echo e(route('products.show', $related->id)); ?>" class="related-product-card" style="text-decoration: none; color: inherit;">
                        <?php if($related->image): ?>
                            <img src="<?php echo e(asset('storage/' . $related->image)); ?>" alt="<?php echo e($related->name); ?>" class="related-product-image">
                        <?php else: ?>
                            <img src="https://dummyimage.com/140x140/f3f4f6/999&text=<?php echo e(urlencode(substr($related->name, 0, 1))); ?>" alt="<?php echo e($related->name); ?>" class="related-product-image">
                        <?php endif; ?>
                        <div class="related-product-info">
                            <div class="related-product-name"><?php echo e(Str::limit($related->name, 40)); ?></div>
                            <div class="related-product-price">Rp <?php echo e(number_format($related->price, 0, ',', '.')); ?></div>
                        </div>
                    </a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <div class="bottom-actions">
            ...
            <a href="<?php echo e(route('checkout.create', ['product_id' => $product->id])); ?>" class="order-btn" onclick="event.preventDefault(); if(!isAuthenticated) { showLoginModal(); } else { window.location.href = this.href; }" style="text-decoration: none; display: flex; align-items: center; justify-content: center;">
                Buat Pesanan
            </a>
        </div>
    </div>
    ...
    <script>
        ...
        addToCartBtn.addEventListener('click', function(e) {
            ...
            const productData = {
                ...
                image: '<?php echo e($product->image ? asset('storage/' . $product->image) : ''); ?>',
                quantity: 1
            };
        ...
        function shareVia(platform) {
            ...
            const title = encodeURIComponent('<?php echo e($product->name); ?>');
            const text = encodeURIComponent('Check out this amazing product: <?php echo e($product->name); ?> - Rp <?php echo e(number_format($product->price, 0, ",", ".")); ?>');
    ...
    <div class="share-modal-overlay" id="shareModalOverlay">
        <div class="share-modal">
            ...
            <div class="share-product-card">
                <img src="<?php echo e($product->image ? asset('storage/' . $product->image) : 'https://via.placeholder.com/80'); ?>" alt="<?php echo e($product->name); ?>" class="share-product-image">
                <div class="share-product-info">
                    <div class="share-product-name"><?php echo e($product->name); ?></div>
                    <div class="share-product-price">Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?></div>
                    <div class="share-product-stock">Stock: <?php echo e($product->stock); ?></div>
                </div>
            </div>
            ...
            <div class="share-options">
                ...
                <div class="share-link-section">
                    ...
                    <div class="share-link-input-wrapper">
                        <input type="text" class="share-link-input" id="productLink" value="<?php echo e(url()->current()); ?>" readonly>
...
<?php /**PATH C:\laragon\www\projectwahab\resources\views/product/detail.blade.php ENDPATH**/ ?>